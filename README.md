...
- Perp AMM: `55CV34QX5ZtPpQ5CJQBeCjHwWgAVQrdiHJXuPmsvdV5v`
- Perp Margin Accounts: `74uHucnSnpqhv3NRpgxxRsQFhaYmw7iuU8jZFzZGBTgx`
...
const program = new Program<PerpAmm>(
  IDL,
  "55CV34QX5ZtPpQ5CJQBeCjHwWgAVQrdiHJXuPmsvdV5v",
  provider
);
```
